...
list_of_variants = 'VCF_filenames.txt';
...
perform_variant_analysis = 0; % enter 1 to turn on custom variant analysis or enter 0 to turn off custom variant analysis
perform_haplotype_analysis = 1; % enter 1 to turn on haplotype analysis or enter 0 to turn off haplotype analysis
...
multiple_match_analysis = 0; % enter 1 to turn on multiple match analysis or enter 0 to turn off multiple match analysis (analyze for sgRNA matching to multiple loci within same sequence)
individual_output = 1; % enter 1 to turn on provide individual outputs for each sequence(s) in batch analysis or enter 0 to skip individual ouputs for each sequence(s) in batch analysis
...
output_to_excel = 0; % enter 1 to output libraries to excel or enter 0 to output analysis to a text file
