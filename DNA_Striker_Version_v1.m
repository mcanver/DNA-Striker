...
for a = starting_number:end_number
    ...
    for b = 1:length(PAM_sequence_list)
        ...
        if perform_variant_analysis == 1 || perform_wgs_analysis == 1
            ...
            if perform_variant_analysis == 1 || perform_wgs_analysis;
            ...
            if twenty_extra_bases == 1 && perform_variant_analysis == 1 || twenty_extra_bases == 1 && perform_wgs_analysis == 1;
        ...
        if end_number > starting_number && perform_batch_output == 1 && perform_variant_analysis == 1 && exist('merge_unique_variant_guides_full','var')==1 && b == length(PAM_sequence_list) || end_number > starting_number && perform_batch_output == 1 && perform_wgs_analysis == 1 && exist('merge_unique_variant_guides_full','var')==1 && b == length(PAM_sequence_list)
...
if perform_variant_analysis == 1 && end_number > starting_number && output_to_excel == 0 && perform_batch_output == 1 || perform_wgs_analysis == 1 && end_number > starting_number && output_to_excel == 0 && perform_batch_output == 1
    array_cell_variant = {'ID' 'PAM' 'sgRNA_Sequence' 'sgRNA_PAM' 'Full_Sequence' 'Strand' 'Chromosome' 'Classification' 'N_W_Alignment_Score' 'No_Variant_ID' 'No_Variant_sgRNA_Sequence' 'No_Variant_PAM_Only' 'No_Variant_Full_Sequence' 'No_Variant_Strand' 'No_Variant_Chromosome' 'Guide_Start_Coordinate' 'Guide_End_Coordinate' 'DSB_Coordinate' 'Guide_Start_Index' 'Guide_End_Index' 'DSB_Index' 'Filename'};
